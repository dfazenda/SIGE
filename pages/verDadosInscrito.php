                        ...
                        <?php
                          ...
                          $id = $_GET['q'];
                          $rs = $aluno -> verDadosInscrito($id);
                          if(!is_array($rs))
                          echo '<meta http-equiv="refresh" content="0;url=inscritos">';

                        ?>

                        <!-- PAGE-HEADER -->
                        <div class="page-header">
                            <h1 class="page-title">Inscrito</h1>
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Inscrito</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Dados do inscrito</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                    ...
                    <div class="row row-sm">
                        <div class="col-lg-12">
                            ...
                            <div class="card-header">
                                    ...
                                    <h3 class="card-title">Dados do inscrito</h3>
                                   
                                    </div>
                                    
                                    <div class="col-1 p-0">
                                    <a href="#" id='editarAluno' class='btn btn-sm btn-primary' style='float:right; left:100%;'><h6><b><i title="Editar" class="fa fa-pencil"></i></b></h6></a>
                                 </div>
                                </div>
                               
                   <div class="card-body" style="">
                  <form class="form_edicao" enctype="multipart/form-data">
                   <input name='controlador' type="hidden" value="<?=md5('alterar_inscrito'). 'f' ?>">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group bmd-form-group">
                          ...
                          <select class="form-control in text-center" required style="color: #001f3f; text-align-last: left; border-bottom-color: #FFF" name="nacionalidade" >
                                   <option <?php if ($rs['nacionalidade']=='') echo 'selected=""'?> value="" selected="" disabled="">Selecioone </option> 
                                  <option <?php if ($rs['nacionalidade']=='Mocambicana') echo 'selected=""'?> value="Mocambicana" >Mocambicana</option> 
                                  <option <?php if ($rs['nacionalidade']=='Estrangeira') echo 'selected=""'?> value="Estrangeira" >Estrangeira</option>
                              </select>
                        </div>
                      </div>
                      <div class="col-md-3" >
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" id="locala_emissao_doc" required name=" naturalidade" maxlength="50" value="<?=$rs['naturalidade']?>"class="form-control">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group bmd-form-group">
                        ...
                        <div class="form-group bmd-form-group">
                          ...
                          <select class="form-control in text-center" required style="color: #001f3f; text-align-last: left; border-bottom-color: #FFF" name="classe" id="classe">
                                  <?=$gestaoInterna->listaDeClassesSelect($rs['classe'])?>
                       ...
                       <div class="col-12">
                          <label style="color: #001f3f"><i>Encarregado de Educação</i></label>
                          <hr style="width: 100% !important; background: #001f3f; height: 2px">
                      </div>
                       ...
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" onload="$(this).is('focus');" minlength="7" required name="nomeEncarregado" maxlength="70" value="<?=$rs['nomeEncarregado']?>" class="form-control" autocomplete="no">
                        </div>
                      </div>
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Local de trabalho:</label>
                          <input type="text" onload="$(this).is('focus');" minlength="7" required name="localDeTrabalho" maxlength="70" value="<?=$rs['localDeTrabalho']?>" class="form-control" autocomplete="no">
                        </div>
                      </div>
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Função:</label>
                          <input type="text" onload="$(this).is('focus');" minlength="7" id="funcao" name="funcao" maxlength="70" value="<?=$rs['funcao']?>" class="form-control" autocomplete="no">
                        </div>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                       ...
                       <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" class="form-control" required autocomplete="no" id="contactoAlternativo" name="contactoAlternativo" value="<?=$rs['contactoAlternativo']?>" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="9">
                        </div>
                      </div>
