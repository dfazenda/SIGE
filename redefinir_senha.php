       ...
       /GLOABAL LOADER -->
        ...
        <div class="page" >
            <div class="">
             ...
             <?php
                $processo = isset($_GET['processo']) ? $_GET['processo'] : 0;
                if($sessao->valida_processo($processo) > 0){
                ?>
                <!-- CONTAINER OPEN -->
            ...
            -->
                ...
                <div class="container-login100" >
                    ...
                    <form id='form_login' class="login100-form validate-form">
                        	<input name='controlador' type="hidden" value="<?=md5('redefinir_senha'). 'f' ?>">
                            <span class="login100-form-title pb-5">

                                <h4 class="text-warning text-center"><b>Redefinir senha<b></h4>
                            </span>
                              ...
                              <div class="panel panel-primary">
                                ...
                                <div class="panel-body tabs-menu-body p-0 pt-5">
                                    <div class="tab-content">
                                       ...
                                       <input class="input100 border-start-0 form-control ms-0" minlength="5" name='usuario' type="hidden" placeholder="" value='<?=$_GET["usuario"]?>'>
                                             <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                                <a href="javascript:void(0)" class="input-group-text bg-white text-muted">
                                                    <i class="zmdi zmdi-eye text-muted" aria-hidden="true"></i>
                                                </a>
                                              
                                                <input class="input100 border-start-0 form-control ms-0" minlength="5" name='senha' type="password" placeholder="Criar nova senha">
              ...
              <?php
                  ...
                  ?>
                       ...
                       <div class="row justifay-content-center">
                          <div class="col-md-6 col-lg-4">
                             <div class="login-wrap py-4">
                              <p class="texte-danger text-center" id="">O seu link expirou. Para recuperar volte a solicitar a recuperação da senha.</p>
                   ...
                   <?php
                     echo'<meta http-equiva="refresh" content="5;url=login">';
                    }
