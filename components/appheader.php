...
require "conexao.php";
 ...
 <div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        <a aria-label="Hide Sidebar" class="app-sidebar__toggle text-center" data-bs-toggle="sidebar" href="javascript:void(0)">
                            
                        </a>
                        <!-- sidebar-toggle-->
                     <a class="logo-horizontal text-center" href="dashboard"><h3 style="margin-left: -50PX;">ILIA - SIGE</h3></a>
                            ...
                            <div class="navbar navbar-collapse responsive-navbar p-0">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <!-- SEARCH -->
                                        <?php if(@$_SESSION['activa'] == 1){ ?>
                                        <div class="dropdown  d-flex">
                                            <a class="nav-link icon theme-layout nav-link-bg layout-setting alterar_tema" controlador = '<?=md5("alterar_tema")."f"?>'>
                                                 <span class=""><i class="fe fe-moon"></i></span>
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                               <!--- <img src="assets/images/brand/logo2.png" alt="profile-user" class="avatar  profile-user brround cover-image">--->
                                               <h6><i class="fe fe-user"></i><?=@$_SESSION['nome_usuario']?></h6>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <div class="text-center">
                                                        <h5 class="text-dark mb-0 fs-14 fw-semibold"><?=@$_SESSION['nome_usuario']?></h5>
                                                        <small class="text-muted"><?=@$_SESSION['usuario']?></small>
                                                    </div>
                                                </div>
                                                <div class="dropdown-divider m-0"></div>
                                                <a class="dropdown-item" href="perfil?q=<?=@$_SESSION['id_entidade']?>">
