                        ...
                        <?php
                          ...
                          if(!is_array($rs))
                          echo '<meta http-equiv="refresh" content="0;url=professores">';
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Dados do professor</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                    ...
                    <div class="row row-sm">
                        <div class="col-lg-12">
                            ...
                            <div class="card-header">
                                    ...
                                    <div class="col-1 p-0">
                                    <a href="#" id='editarProfessor' class='btn btn-sm btn-primary' style='float:right; left:100%;'><h6><b><i title="Editar" class="fa fa-pencil"></i></b></h6></a>
                                 </div>
                                </div>
                               
                   <div class="card-body" style="">
                  <form class="form_edicao" enctype="multipart/form-data">
                   <input name='controlador' type="hidden" value="<?=md5('alterar_professor'). 'f' ?>">
