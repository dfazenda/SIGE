                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Cadastrar do aluno</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                  ...
                  <form class="form_cadastro" enctype="multipart/form-data">
                   <input name='controlador' type="hidden" value="<?=md5('inserir_aluno'). 'f' ?>">
                    <div class="row">
                      <div class="col-md-3">
                      ...
                      <label style="color: #001f3f"><b><i>Dados Pessoais</i></b></label>
                      ...
                      <div class="col-md-3" >
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" onfocus="(this.type = 'date')" required onblur="(this.type = 'text')" id="dob" name="dataDeNascimento" value="" min="" max="<?=$dataIdadeMinAluno?>" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-5" >
                       ...
                       <div class="col-md-2">
                        <div class="form-group bmd-form-group">
                          ...
                          <select class="form-control in text-center" required style="color: #001f3f; text-align-last: left; border-bottom-color: #FFF" name="nacionalidade" >
                                  <option value="" selected="" disabled="">Selecioone </option> 
                                  <option value="Masculino" >Mocambicana</option> 
                                  <option value="Femenino" >Estrangeira</option> 
                              </select>
                        </div>
                      </div>
                      <div class="col-md-4" >
                      ...
                      <div class="col-md-6">
                       ...
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" onload="$(this).is('focus');" minlength="7" name="funcao" maxlength="70" value="" class="form-control" autocomplete="no">
                        </div>
                      </div>
                      <div class="col-12">
                          <label style="color: #001f3f"><i>Contactos</i></label>
                          <hr style="width: 100% !important; background: #001f3f; height: 2px">
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" class="form-control" required autocomplete="no" id="contacto" name="contactoAlternativo" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="9">
                        </div>
                      </div>
