                        ...
                        <?php
                          ...
                          if(!is_array($rs))
                          echo '<meta http-equiv="refresh" content="0;url=alunos">';
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Aluno</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Dados do aluno</li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                  ...
                  <form class="form_edicao" enctype="multipart/form-data">
                   <input name='controlador' type="hidden" value="<?=md5('alterar_aluno'). 'f' ?>">
                      ...
                      <div class="col-12">
                       ...
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" onload="$(this).is('focus');" minlength="2" required name="localDeTrabalho" maxlength="70" value="<?=$rs['localDeTrabalho']?>" class="form-control" autocomplete="no">
                        </div>
                      </div>
                       <div class="col-md-4">
                        <div class="form-group bmd-form-group">
